...
const CONTACT_FAQS: readonly FaqEntry[] = [
  ...
  },
  {
    ...
    answer: `${STORE.address.full}. In the heart of Rainier Valley on Rainier Ave South, 5 minutes north of Othello Light Rail Station on foot.`,
  },
  {
    question: "What are your hours?",
    answer:
      "Open daily 8 AM to 11 PM — every day of the year including holidays. Pickup orders cut off 15 minutes before close.",
  },
  {
              ...
              {[
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="font-semibold text-stone-800 group-hover:text-indigo-700 transition-colors text-sm truncate">
                      {value}
                    </div>
                  </div>
                </a>
            ...
            <div className="rounded-2xl border border-stone-100 overflow-hidden bg-indigo-50/30">
              <div className="px-4 py-3 flex justify-between items-center border-b border-indigo-100">
                ...
                <span className="font-bold text-indigo-700 text-sm">
                  {STORE.hours[0].open} – {STORE.hours[0].close}
                </span>
              </div>
