...
Yes — 20% off for active military, veterans, first responders (police · fire · EMS), healthcare workers, and K-12 teachers. Full eligibility at ${website}/heroes.
...
${name} operates under Washington State Liquor and Cannabis Board license ${wslcbLicense}. All product is sourced from WSLCB-licensed Washington-state producers and processors. Tax compliance is handled per WAC 314-55. The store complies with WAC 314-55-079 (premises rules), WAC 314-55-155 (advertising restrictions), and WAC 314-55-077 (product labeling and medical claims).
