    ...
    <div className="space-y-4">
      ...
      <div className="rounded-2xl border border-stone-200 bg-white divide-y divide-stone-100 overflow-hidden shadow-sm">
        ...
        <div className="px-5 py-4 flex items-center justify-between">
          ...
          >
            <span className={`absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full shadow-sm transition-transform ${smsOptIn ? "translate-x-5" : ""}`} />
          </button>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-stone-200 bg-white divide-y divide-stone-100 overflow-hidden shadow-sm">
        ...
        <div className="px-5 py-4">
          <SignOutButton redirectUrl="/">
            <button className="text-sm text-red-500 hover:text-red-600 font-medium transition-colors">Sign out of account</button>
          </SignOutButton>
        </div>
      </div>
    </div>
