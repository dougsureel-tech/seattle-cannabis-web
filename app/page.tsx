...
const CATEGORIES = [
  ...
  { icon: "💨", label: "Vapes",        desc: "Carts & all-in-ones",           href: "/menu", color: "from-indigo-500 to-blue-800" },
  ...
  { icon: "💧", label: "Tinctures",    desc: "Oils & capsules",               href: "/menu", color: "from-teal-500 to-indigo-700" },
];
    ...
    <>
      ...
      <section className="relative bg-indigo-950 text-white overflow-hidden">
        ...
        <div className="absolute inset-0"
          style={{ backgroundImage: "radial-gradient(ellipse 70% 80% at 15% 50%, #1e1b4b44, transparent), radial-gradient(ellipse 50% 60% at 90% 20%, #4338ca22, transparent)" }} />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-12 lg:gap-16">
            ...
            <div className="flex-1 space-y-7">
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <span className="text-indigo-400/60 text-xs font-medium uppercase tracking-widest">Rainier Valley, Seattle</span>
              </div>
              ...
              <div>
                ...
                <p className="text-indigo-100/60 text-lg sm:text-xl leading-relaxed max-w-lg mt-5">
                  Veteran-owned and community-rooted. Premium cannabis, expert budtenders — open daily in the heart of Rainier Valley.
                </p>
              </div>
            ...
            <div className="hidden lg:block shrink-0">
              <div className="rounded-3xl border border-white/15 p-6 w-72 space-y-5" style={{ background: "rgba(255,255,255,0.06)", backdropFilter: "blur(12px)" }}>
                ...
                <div className="flex items-start gap-3">
                  <svg className="w-4 h-4 mt-0.5 text-indigo-400 shrink-0" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-stone-100 overflow-hidden bg-indigo-50/50">
              ...
              <div className="px-5 py-3 text-sm text-stone-500">365 days a year including holidays · Rainier Valley, Seattle</div>
            </div>
            <div>
