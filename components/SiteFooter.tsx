      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10 sm:py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <address className="not-italic text-sm text-indigo-300/80 space-y-1.5">
            ...
            <a href={`mailto:${STORE.email}`} className="block hover:text-white transition-colors text-xs">{STORE.email}</a>
          </address>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            {STORE.social.instagram && (
              <a href={STORE.social.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-xs text-indigo-300 hover:text-white transition-all">
                <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
            ...
            {STORE.social.facebook && (
              <a href={STORE.social.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook"
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-xs text-indigo-300 hover:text-white transition-all">
                <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2">
            {[
              ...
              <li key={href}>
                <Link href={href} className="text-xs text-indigo-300/80 hover:text-white transition-colors">{label}</Link>
              </li>
            ))}
          </ul>
        </div>
