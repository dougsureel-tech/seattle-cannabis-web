...
// hardcoded for now (real review-aggregator integration is a follow-up);
...
// queries — "is Seattle Cannabis Co any good?" — and they're what populates
...
const REVIEWS: Review[] = [
  ...
  },
  {
    ...
    city: "Columbia City",
    rating: 5,
    text: "Place is veteran-owned and you can feel it — disciplined, well-run, no nonsense. 15% off online orders is the right move. I order ahead, swing by between meetings, in and out in 4 minutes flat.",
    date: "2026-04-26",
  },
  {
    author: "Anna F.",
